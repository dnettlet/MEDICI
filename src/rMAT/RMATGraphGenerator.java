...
public class RMATGraphGenerator {
    ...
    {
        this(outputter, pA, pB, pC, pD, nVertices,nEdges,Runtime.getRuntime().availableProcessors());
    }

	public RMATGraphGenerator(GraphOutput outputter, double pA, double pB, double pC, double pD, int nVertices,long nEdges,int nThreads) {
